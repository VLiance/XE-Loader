...
inl BOOL WINAPI pipe_GetPixelFormat(HDC hdc){
...
inl BOOL WINAPI pipe_SetPixelFormat(void* hdc, int format, void* ppfd){
...
inl int WINAPI pipe_ChoosePixelFormat(void* hdc, void* ppfd){
...
inl int WINAPI pipe_DescribePixelFormat(HDC hdc,int iPixelFormat,UINT nBytes,LPPIXELFORMATDESCRIPTOR ppfd){
...
inl BOOL WINAPI  pipe_ShowWindow(HWND hWnd,int nCmdShow){
...
inl HMODULE  WINAPI pipe_GetModuleHandleA(LPCSTR lpModuleName){
...
inl HMODULE  WINAPI pipe_GetModuleHandleW(LPCWSTR lpModuleName){
...
inl int pipe_setvbuf( FILE * stream, char * buffer, int mode, size_t size ){
...
inl HANDLE WINAPI pipe_CreateToolhelp32Snapshot(DWORD  dwFlags,DWORD  th32ProcessID){
...
inl WINAPI BOOL pipe_ClientToScreen(HWND hWnd,LPPOINT lpPoint){
...
LONG WINAPI pipe_UnhandledExceptionFilter(void* ExceptionInfo){
